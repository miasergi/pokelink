...
export default function CompareSheet({ a, onClose }: { a: CompareBlock; onClose: () => void }) {
  ...
  return createPortal(
    <div className="fixed inset-0 z-[94]" onClick={onClose}>
      ...
      <div
        className="absolute inset-x-0 bottom-0 mx-auto w-full max-w-md max-h-[88svh] overflow-y-auto no-scrollbar rounded-t-3xl border-t border-x border-slate-700 bg-slate-900 p-4 pb-[max(1rem,env(safe-area-inset-bottom))] animate-sheet-up"
