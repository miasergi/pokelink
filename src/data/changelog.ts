...
export const CHANGELOG: ChangelogEntry[] = [
  {
    ...
    changes: [
      ...
      'EL CAMINO ES EL DOBLE DE LARGO: cada medalla son ahora ~14 casillas en vez de 6-8 (la región pasa de 67 a 130). Los combates siguen dando lo de siempre (salvaje +1, entrenador +2, Team Rocket y jefes +3, que ahora paga como jefe), así que con la curva nueva hacía falta más camino para llegar al nivel del líder: con los tramos cortos te plantabas ante el primer gimnasio a nivel 9 contra un líder de 14. Hay un Centro Pokémon a mitad de tramo, además del de antes del gimnasio.',
