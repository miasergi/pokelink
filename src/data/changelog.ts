...
export const CHANGELOG: ChangelogEntry[] = [
  {
    ...
    changes: [
      ...
      'Sigues empezando a NIVEL 5, que es donde está la gracia, pero la primera ruta ya no reparte esos 9 niveles en línea recta: arranca pegada a tu nivel (4, 5, 6, 7) y el repecho llega al final (9, 11) justo antes del gimnasio, cuando ya tienes equipo.',
      'Los combates siguen dando lo de siempre (salvaje +1, entrenador +2, Team Rocket y jefes +3), pero AHORA CADA CASILLA CUENTA: tienda, objeto, captura, intercambio, evento y Centro Pokémon dan +1 nivel al equipo por pisarlas. Antes la mitad del recorrido no daba nada y con la curva nueva era imposible llegar al nivel de los líderes. El tope por medallas sigue mandando.',
