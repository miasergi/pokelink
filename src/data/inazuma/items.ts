...
export const ITEMS: InazumaItem[] = [
  ...
  { id: 'pocion-pt', name: 'Poción de PT', kind: 'consumible', desc: 'Recupera el 50 % del depósito de PT a un jugador.', price: 300, consumable: true },
  { id: 'pocion-pt-max', name: 'Superpoción de PT', kind: 'consumible', desc: 'PT al MÁXIMO a un jugador.', price: 700, consumable: true },
  { id: 'pocion-aguante', name: 'Poción de Aguante', kind: 'consumible', desc: 'Recupera el 50 % del aguante a un jugador.', price: 300, consumable: true },
  { id: 'pocion-aguante-max', name: 'Superpoción de Aguante', kind: 'consumible', desc: 'Aguante al MÁXIMO a un jugador.', price: 700, consumable: true },
