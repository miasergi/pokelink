...
export const FIGHTERS: FighterData[] = [
  // =========================================================== ALIADOS ===
  {
    ...
    learn: [{ level: 8, tech: 'concentracion' }, { level: 18, tech: 'martillo' }, { level: 30, tech: 'genkidama' }, { level: 46, tech: 'ult_kamehameha' }],
  ...
  },
  {
    ...
    learn: [{ level: 14, tech: 'taiyoken' }, { level: 26, tech: 'concentracion' }, { level: 52, tech: 'ult_kamehameha' }],
    forms: ['sobrecarga'],
  ...
  },
  {
    ...
    learn: [{ level: 12, tech: 'regeneracion' }, { level: 24, tech: 'muro' }, { level: 44, tech: 'ult_makankosappo' }],
  ...
  },
  {
    ...
    learn: [{ level: 10, tech: 'kamehameha' }, { level: 20, tech: 'concentracion' }, { level: 32, tech: 'ondaexpansiva' }, { level: 44, tech: 'ult_padrehijo' }],
  ...
  },
  {
    ...
    learn: [{ level: 14, tech: 'bigbang' }, { level: 26, tech: 'resplandor' }, { level: 46, tech: 'ult_resplandor' }],
  ...
  },
  {
    ...
    learn: [{ level: 16, tech: 'martillo' }, { level: 28, tech: 'infinitybullet' }, { level: 48, tech: 'ult_dragon' }],
    forms: ['ssj', 'ssj2'],
  ...
  },
  {
    ...
    learn: [{ level: 18, tech: 'ondaexpansiva' }, { level: 50, tech: 'ult_dragon' }],
    forms: ['sobrecarga'],
  ...
  },
  {
    ...
    learn: [{ level: 40, tech: 'ult_supernova' }],
  ...
  },
  {
    ...
    learn: [{ level: 40, tech: 'ult_kamehameha' }],
  ...
  },
  {
    ...
    learn: [{ level: 40, tech: 'ult_aniquilacion' }],
  ...
  // ============================ ARCO CLÁSICO (Dragon Ball) — ALIADOS ===
  {
    ...
    learn: [{ level: 10, tech: 'kamehameha' }, { level: 22, tech: 'combo' }, { level: 34, tech: 'punokamikaze' }, { level: 50, tech: 'ult_kamehameha' }],
    forms: ['kaioken', 'ozaru'],
  ...
  },
  {
    ...
    learn: [{ level: 16, tech: 'concentracion' }, { level: 28, tech: 'ondaexpansiva' }, { level: 48, tech: 'ult_kamehameha' }],
    forms: ['sobrecarga'],
  ...
  },
  {
    ...
    learn: [{ level: 40, tech: 'kamehameha' }, { level: 55, tech: 'resplandor' }, { level: 50, tech: 'ult_kamehameha' }],
    forms: ['ssj', 'ssj2', 'ssj3'],
  ...
  },
  {
    ...
    learn: [{ level: 44, tech: 'ult_aniquilacion' }],
  ...
  },
  {
    ...
    learn: [{ level: 44, tech: 'ult_kamehameha' }],
  ...
  },
  {
    ...
    learn: [{ level: 40, tech: 'ult_dragon' }],
