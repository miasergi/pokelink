...
export const ITEMS: ItemData[] = [
  ...
  { id: 'z-move', name: 'Movimiento Z', category: 'battle', description: 'Otorga el MOVIMIENTO Z (potencia 160), el 4º y máximo nivel. El Pokémon debe estar ANTES a potencia máxima (120). Solo en la tienda desde la 7ª medalla.', price: 10000, sprite: ITEM_SPRITE('z-power-ring') },
