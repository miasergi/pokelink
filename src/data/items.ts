...
export const ITEMS: ItemData[] = [
  ...
  { id: 'double-glove', name: 'Guante Doble', category: 'held', description: 'Tus ataques golpean 2 veces (cada golpe ~60% del daño). Anula la Cinta Focus.', price: 3500, sprite: ITEM_SPRITE('muscle-band') },
